...
create table if not exists public.communication_email_templates (
  ...
  variables       jsonb       not null default '{"headerBg":"#4C2A92","accentColor":"#E8A020","footerText":"BLW Canada"}'::jsonb,
...
values
  (
    ...
    'announcements',
    '<div style="font-family:sans-serif;max-width:560px;margin:0 auto;"><div style="background:linear-gradient(135deg,{{headerBg}},#6B3FD4);padding:20px;border-radius:8px 8px 0 0;margin-bottom:24px;"><div style="color:white;font-size:18px;font-weight:800;">Weekly Update</div><div style="color:rgba(255,255,255,0.7);font-size:12px;margin-top:2px;">{{date_today}}</div></div><div style="color:#2D2A22;font-size:14px;line-height:1.7;padding:0 20px;"><h2 style="margin:16px 0 12px;font-size:16px;">{{meeting_label}}</h2><p>{{recap}}</p><p><strong>Next meeting:</strong> {{next_date}}</p></div><div style="margin-top:24px;padding:20px;border-top:1px solid #EDE8DC;text-align:center;font-size:11px;color:#9E9488;">{{footerText}} | Sent via BLW Canada OS<br><a href="{{unsubscribe_link}}" style="color:#9E9488;">Unsubscribe</a></div></div>',
    true,
    '{"headerBg":"#4C2A92","accentColor":"#E8A020","footerText":"BLW Canada"}'::jsonb
  ),
  (
    'Event Invitation',
    'events',
  ...
  (
    ...
    true,
    '{"headerBg":"#C94830","accentColor":"#C94830","footerText":"BLW Canada"}'::jsonb
  ),
  (
    ...
    true,
    '{"headerBg":"#6B3FD4","accentColor":"#E8A020","footerText":"BLW Canada"}'::jsonb
  ),
  (
    'Leadership Meeting',
    'operational',
  ...
  (
    ...
    true,
    '{"headerBg":"#9A6000","accentColor":"#E8A020","footerText":"BLW Canada"}'::jsonb
  ),
  (
    'Group Signup',
    'events',
  ...
  (
    ...
    true,
    '{"headerBg":"#1A56DB","accentColor":"#1A56DB","footerText":"BLW Canada"}'::jsonb
  )
